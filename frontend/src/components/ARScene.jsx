                    ...
                    {calibMode === 'calibrated' && anchorLoc && pois.map(poi => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <a-plane color="#1a1a2e" height="1.2" width="3" position="0 0.6 0.02" material="opacity: 0.95; side: double">
                                     <a-text value={poi.name} align="center" color="#4ECDC4" width="6" position="0 0.3 0.01"></a-text>
                                     <a-text value={`${Math.hypot(coords.x - camX, coords.z - camZ).toFixed(1)} m`} align="center" color="#FF6B6B" width="8" position="0 -0.05 0.01"></a-text>
                                     <a-text value="Toca para Detalles" align="center" color="#FFFFFF" width="4" position="0 -0.4 0.01"></a-text>
                                </a-plane>
                            </a-entity>
                        );
                    })}
